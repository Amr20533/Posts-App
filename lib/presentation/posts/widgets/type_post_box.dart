...
class _TypePostBoxState extends State<TypePostBox> {
                        ...
                        BlocConsumer<PostCubit, PostStates>(
                          ...
                          builder: (context, state) {
                            final bool isCurrentlyUploading = _isUploading ||
                                (state is PostGetSuccess && state.isUploading);

                            return ValueListenableBuilder<bool>(
                              valueListenable: _isPostButtonEnabled,
                              builder: (context, isEnabled, child) {
                                final bool canSubmit = isEnabled && !isCurrentlyUploading;

                                return ElevatedButton(
                                  onPressed: canSubmit
                                      ? () {
                                    setState(() {
                                      _isUploading = true; // Instantly start spinner on tap
                                    });
  ...
  @override
  void dispose() {
    _captionController.removeListener(_checkInputValidity);
